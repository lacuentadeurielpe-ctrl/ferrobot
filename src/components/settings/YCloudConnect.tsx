...
const ESTADO_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  desconectado: { label: 'Desconectado', cls: 'bg-zinc-100 text-zinc-500' },
}
    ...
    <div className="bg-white border border-zinc-200 rounded-2xl p-5">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h3 className="font-semibold text-zinc-900 text-sm">WhatsApp (YCloud)</h3>
            {configurado && (
      ...
      {vista === 'estado' && configurado && (
        <div>
          ...
          <div className="space-y-1.5 mb-4">
            <div className="flex items-center gap-2">
              <span className="text-zinc-400 text-xs w-28 shrink-0">Número WhatsApp</span>
              <span className="text-sm font-medium text-zinc-800">+{numeroWhatsapp}</span>
            </div>
            {ultimoMensajeAt && (
              <div className="flex items-center gap-2">
                <span className="text-zinc-400 text-xs w-28 shrink-0">Último mensaje</span>
            ...
            <div className="flex items-center gap-2">
              <span className="text-zinc-400 text-xs w-28 shrink-0">API Key</span>
      ...
      {vista === 'editar' && (
        <form onSubmit={guardar} className="space-y-4">
          {success && (
            <div className="px-3 py-2 bg-green-50 border border-green-200 rounded-xl text-sm text-green-700">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-zinc-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-300"
              required
            />
          ...
          <div>
            <label className="block text-xs font-medium text-zinc-700 mb-1">
              ...
              {configurado && <span className="text-zinc-400">(dejar vacío para mantener la actual)</span>}
            </label>
            <div className="relative">
              <input
                ...
                className="w-full border border-zinc-300 rounded-xl px-3 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-300"
              />
              <button
                type="button"
          ...
          <div>
            <label className="block text-xs font-medium text-zinc-700 mb-1">
              Webhook Secret{' '}
              <span className="text-zinc-400">(opcional — dejar vacío para mantener el actual)</span>
            </label>
            <div className="relative">
              <input
          ...
          <div className="flex items-center gap-3 pt-1">
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-white text-sm font-medium rounded-xl disabled:opacity-50 transition-colors"
            >
